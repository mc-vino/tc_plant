  ...
  return (
    <>
      <div className={hasImage ? "grid gap-6 md:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] md:gap-10" : ""}>
        {hasImage && (
          // Shorter crop on phones so the name and price stay above the fold.
          <div className="relative aspect-[3/2] max-h-[38vh] overflow-hidden rounded-card border border-line bg-accent-soft md:aspect-[4/5] md:max-h-none">
            <Image
